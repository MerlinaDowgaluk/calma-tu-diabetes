			...
			<div className="d-flex col-12">
				<div className="col-4 mt-4">
					<Link to="/" className="text-decoration-none d-flex ms-5">
						<span className="font-black text-xl" style={{color: "#714994", width: "100%"}}>CALMA TU DIABETES</span>
					</Link>
				</div>
				...
				<div className="col-4 d-flex justify-content-end mt-4">
					<a href="https://www.instagram.com/calmatudiabetes/" target="_blank" className="text-xl"><i class="fab fa-instagram fa-lg me-5 mt-2" style={{color: "#714994"}}></i></a>
				</div>
			</div>
		</nav>
